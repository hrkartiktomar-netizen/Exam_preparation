# IFSCA-Compliance-Handbook — OCR transcription (Gemini)

[logo: aml india] [logo: NIYEAHMA]
...
7th Floor, Devpath Complex, B/h. Lal Bunglow, Off. C.G. Road,  
Ahmedabad - 380 006.
...
[logo: aml india] [logo: NIYEAHMA N]
...
Money Laundering is a process carried out to route the illegally obtained funds through a series of transactions to disguise the source and owner of such illicit proceeds and make is appear as if generated from legitimate activities.
...
<div align="right">Regulatory Framework governing AML Compliance</div>
...
[logo: aml india N NIYAHMA]

---

## 1.0 AML Principal Officer Appointment

IFGCA (AML, CTF, & KYC) Guidelines mandate that regulated entities designate an AML Principal Officer (also known as a Compliance Officer) to handle the entity's AML measures, ensure regulatory compliance, and protect the business against financial crime risks.
...
[logo: Appointment of a Principal Officer] Appointment of a Principal Officer
...
[logo: Key Roles and Responsibilities] Key Roles and Responsibilities
...
[logo: document with thumb] Easy to understand

[logo: settings and gears] Practical to implement in the course of business operations

[logo: hand with shield] Empower the risk management efforts

[logo: document with gear] Enable AML regulatory compliance
...
<div class="box">
  ...
  <div class="text">Not covering all the Essential Elements</div>
</div>

<div class="box">
  <div class="number">02</div>
  <div class="text">Unsatisfactory Documentation of a Risk-Based Approach</div>
</div>

<div class="box">
  <div class="number">03</div>
  <div class="text">Inadequate EDD Procedures</div>
</div>

<div class="box">
  <div class="number">04</div>
  <div class="text">Ineffective Ongoing Monitoring Procedures</div>
</div>

<div class="box">
  <div class="number">05</div>
  <div class="text">Missing Authorization</div>
</div>

<div class="box">
  <div class="number">06</div>
  <div class="text">Inadequate Change Management</div>
</div>

<div class="box">
  <div class="number">07</div>
  <div class="text">Not Updated with the Latest Regulatory Requirements</div>
</div>

<div class="box">
  <div class="number">08</div>
  <div class="text">Inadequate Communication about AML policies and procedures</div>
</div>

<div class="box">
  <div class="number">09</div>
  <div class="text">Missing out on procedures on Countering the Proliferation Financing</div>
</div>

<div class="box">
  <div class="number">10</div>
  <div class="text">Improper Record-Keeping Measures</div>
</div>
...
A regulated entity must take the necessary steps to identify and verify the national person appointed by the customer to act on their behalf.
...
Nature of customer's activites
...
**Enhanced Customer Due Diligence Process: Additional Checks and**
**Verification Measures**

Collect **additional information** about the customer -
Occupation, Information available through public databases
and internet (adverse media and social media search)

Examine the financial position of the customer and beneficial
owners- Source of Wealth and Source of Funds using
independent inquiry with client, using credible database

Understand and record the purpose of transaction and nature
of business relationship

Obtain senior management approval

Enhanced ongoing monitoring of the business
relationship (customer profile and transactions)

First payment through customer's own bank account following
adequate CDD procedures
...
The frequency or ongoing monitoring of transactions and business relationships depends upon the customer's ML/FT risk profile, i.e., the higher the risk, the more stringent the monitoring norms.
...
**4-Step Process for Identification and Reporting of Suspicious
Transactions**

01
[icon]
Detect suspicious indicators
Identify the red-flags or risk indicators suggesting funds are
from illegal activity or transaction attempted to hide the
source of criminal proceeds.

02
[icon]
Ask questions to the customer
Inquire the customer to seek a reasonable explanation for
the detected ML/FT indicators No "tipping off!"

03
[icon]
Review customer records
Review customer information and past transaction to
understand whether the indicators are justifiable and
consistent with the customer's profile.

04
[icon]
Evaluate collected information
Evaluate suspicious indicators, the explanation offered by the
customer and the customer's profile to determine whether
the transaction is linked to proceeds of crime or terrorism
financing If yes, file STR with the FIU-IND.
...
| | |
|---|---|
| Understand AML<br>regulatory<br>framework | Have sound<br>knowledge of ML/FT<br>typologies |
| Comprehend and<br>impelement internal<br>AML Program | Identify the<br>transactions<br>related to ML/FT |
| Understand own<br>duties towards AML | AML<br>Training for<br>empowering<br>employees<br>to | Promptly report the<br>identified ML/FT<br>suspicions |

*\*Relevant Employees (including new joiners):*

| | | | |
|---|---|---|---|
| Senior<br>Management | Employees<br>engaging with<br>customers | Compliance<br>Team | Any other<br>employee who<br>may encounter<br>& ML/FT red flags |
...
The regulated entities are permitted to retain the AML records in an
electronic form or can even be kept outside IFSC. Here, the only
condition is that such records must be easily accessible and
maintained in a manner that adheres to the IFSCA (AML, CTF, & KYC)
Guidelines.
...
[logo: aml india] [logo: N NIYEAHMA]
...
NIYEAHMA is a global AML consulting firm in India assisting reporting
entities to comply with the requirements of the Prevention of Money
Laundering Act, 2002 and the International Financial Service Centre
Authority (AML, CTF, and KYC) Guidelines, 2022.

We are continuously striving to improve businesses' compliance in
India, helping them implement relevant controls, improve KYC and
customer onboarding processes, and assist in setting up a solid
in-house AML compliance department to reduce money laundering
risks.

With our years of global experience in AML/CFT compliance and
understanding of regulated businesses, we offer tailored consultancy
services.
...
01 Studying the business to identify AML requirements

02 Appointment of AML Principal Officer and Competent Team

03 Developing AML/CFT Program

04 Defining the Roles and Responsibilities

05 Imparting adequate AML Training

06 Here you go with a strong In-house AML Compliance Department
...
01 Review of the existing AML program

02 High-level observation of the company's AML framework

03 Identifying areas for process improvements, if any

04 Recommending the remediation plan to smoothen the AML process

05 Observations on the overall AML compliance level of the company
...
[logo: aml india NIYAHMA]

[photo: Jyoti Maheshwari]
...
Jyoti is a Chartered Accountant
and Certified Anti-Money
Laundering Specialist (CAMS),
having around 7 years of hands-on
experience in regulatory
compliance, legal advisory,
policy-making, tax consultation,
and technology project
implementation.

Jyoti holds experience with AML
regulations prevalent across
various countries. She helps
companies with risk assessment,
designing and deploying adequate
mitigation measures, and
implementing the best
international practices to combat
...
Dipali is an Associate member of
ICSI and has a Bachelor's in
Commerce and a General Law
degree. She has 7 years of overall
experience in the compliance
domain, including Anti-Money
Laundering, due diligence,
secretarial audit, and managing
scrutiniser functions.

She currently assists clients by
advising and helping them
navigate the legal and regulatory
challenges of AML laws. She also
helps companies develop,
implement, and maintain effective
AML/CFT and sanctions programs.

She specialises in Enterprise-Wide
Risk Assessment, Customer Due
Diligence, and Customer Risk
Assessment.

[photograph of Dipali Vora]
...
aml india
[envelope icon] info@amlindia.in
[globe icon] www.amlindia.in

N NIYEAHMA
[envelope icon] info@niyeahma.com
[globe icon] www.niyeahma.com

Follow us on [logo: LinkedIn] [logo: YouTube] [logo: Facebook] [logo: WhatsApp]
