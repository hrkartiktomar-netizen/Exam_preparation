# IFSCA-Grade-A-Officer-2022-Phase-1-Paper-2-Previous-Year-Paper — OCR transcription (Gemini)
...
Under the NEP, a mother tongue will be the medium of instruction till _______ or preferably till __________.
...
on its performance across the 16 SDGs. A state in the Front runner category must be in the range of ___________.
...
Under the Pradhan Mantri Shram Yogi Maan-dhan (PM-SYM), Each subscriber shall receive minimum assured pension of Rs 3000/- per month after attaining the age of ________.
...
________________ are core to the domain of population studies.
