# discovered_016_IFSCA_Grade_A_2024_Memory_Based_Phase_1-Question_Paper_1 — OCR transcription (Gemini)
...
[logo: Staff Selection Commission]
[logo: Delhi Police]
...
**Q11. Statements:**
$\mathbf{R > K \le G = C < Z ; C \le E = A \ge S}$
**Conclusions:**
**I) K \le A**
**II) Z > S**
**III) E > K**
...
**Q12. Statements:**
$\mathbf{S > I = W \ge C \ge A = U ; B > W \le Y = E}$
**Conclusions:**
**I) E \ge A**
**II) U < B**
**III) Y > S**
...
*(Note: The diagram above represents the ASCII layout corresponding to the image's geometric line drawing containing points A, B, C, D, E, F, G, I with dimensions 7m, 14m, 9m, 10m, 5m, 4m).*

Q18. What is the direction of the girl's current position with respect to the boy's starting position?
A. Northeast
B. Southeast
C. East
D. West
...
**Instruction (6-12): Read the given passage and answer the questions based on the passage.**
...
Q16. The committee's decision was met with widespread approval and was seen as a highly *commendable* move.
A. controversial
B. admirable
C. questionable
D. ambiguous
...
Q17. The new software program is designed to significantly *enhance* productivity and efficiency in the workplace.
A. reduce
...
**Q20. The team was able to _____ the project ahead of schedule due to their effective management and coordination.**
A. delay
B. advance
C. hinder
D. undermine
...
**Q21. To ensure the accuracy of the research findings, it is important to _____ all sources of data before drawing any conclusions.**
A. fabricate
B. disregard
C. validate
D. ignore
...
[Image: Illustration of three workers with tools]
...
| 9. | **Tarang Shakti-2024** | - **First ever Indian multinational air exercise.** <br> - To be hosted by the **IAF** in **two phases.** <br> - **10 countries invited to participate in the exercise.** |
|---|---|---|
...
E. Bangladesh
**Answer: B**
**Q23. Who is the current Chairperson of the International Financial Services Centres Authority (IFSCA)?**
A. Shri Ajay Tyagi
B. Shri K. Rajaraman
...
E. Shri Rama Nambiar
**Answer: B**
**Q24. How many registered International Insurance Offices (IIOs) are there in the Life Segment after IFSCA granted Certificate of Registration (CoR) to Canara HSBC Life Insurance Company Ltd. In June 2024?**
A. 3
B. 5
C. 7
D. 12
E. 15
**Answer: B**
**Q25. Which phase of the Pradhan Mantri Gram Sadak Yojana (PMGSY) was announced in the Union Budget 2024?**
A. Phase I
B. Phase II
C. Phase III
D. Phase IV
...
E. $300,000
**Answer: D**
**Q10. The Stand-Up India scheme aims to help Scheduled Caste (SC), Scheduled Tribe (ST),**
**and women entrepreneurs establish new businesses in which sectors?**
A. Trading
B. Manufacturing
C. Services
...
**Q18. Which accounting concept guides a firm shows expenses and income of the same accounting period at the same time?**
A. Going Concern
B. Consistency
C. Matching
D. Accrual
...
**Q42. Which eight-time Olympic gold medallist has been chosen as the ambassador for the**
...
**Q43. Which health insurance scheme in India aims to achieve Universal Health Coverage**
**(UHC)?**
...
**Q44. What is the name of the Reusable Launch Vehicle for which ISRO conducted the third**
**Landing Experiment (LEX) on June 23 at the Aeronautical Test Range (ATR) in Chitradurga,**
**Karnataka?**
A. Vikas
B. Pushpak
C. Gaganyaan
...
**Q45Which organization recognized the name "Statio Shiv Shakti" for the landing site of**
